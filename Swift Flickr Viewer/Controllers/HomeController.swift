...
extension HomeController {
    func generateCollections() {
        _collections = [
            ItemCollection(title: "Your Tags", tags: [Item(title: "Mountains",    type: CollectionType.tag.rawValue),
            ...
            ItemCollection(title: "Your Groups", tags: [Item(title: "16978849@N00", type: CollectionType.group.rawValue),
